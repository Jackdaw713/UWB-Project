...
set(NRFXLIB_DIR          C:/ncs/v3.3.0/nrfxlib            CACHE STRING "nrfxlib folder")
set(NRF_SECURITY_ROOT    C:/ncs/v3.3.0/nrf/subsys/nrf_security          CACHE STRING "nrf_security root folder")
set(OBERON_PSA_CORE_PATH C:/ncs/v3.3.0/modules/crypto/oberon-psa-crypto  CACHE STRING "oberon-psa-core folder")
set(ARM_MBEDTLS_PATH     C:/ncs/v3.3.0/modules/crypto/mbedtls            CACHE STRING "Mbed TLS folder")
set(NRF_DIR              C:/ncs/v3.3.0/nrf                              CACHE STRING "NRF folder")
set(TFM_BOARDS_NRF_DIR   C:/ncs/v3.3.0/nrf/modules/trusted-firmware-m/tfm_boards CACHE STRING "tfm_boards folder")
...
set(PSA_CRYPTO_CONFIG_INTERFACE_PATH    C:/ncs/v3.3.0/nrf/samples/bluetooth/central_uart_test/build/generated/interface_nrf_security_psa CACHE STRING "Path used for generated PSA crypto configuratiosn for the interface")
set(PSA_CRYPTO_CONFIG_LIBRARY_PATH      C:/ncs/v3.3.0/nrf/samples/bluetooth/central_uart_test/build/generated/library_nrf_security_psa CACHE STRING "Path used for generated PSA crypto for library builds")
