...
#define APP_NAME "DSTWR INIT MULTI-NODE v2.1 (32-BIT)"
...
int app_main(void)
{
    ...
    LOG_INF("Basliyor... Veriler Initiator ekranina dusecek! (32-Bit Modu)");
                ...
                if (ret == DWT_SUCCESS) {
                    ...
                    if (status_reg & SYS_STATUS_RXFCG_BIT_MASK) {
                        ...
                        if (memcmp(rx_buffer, rx_report_msg, ALL_MSG_COMMON_LEN) == 0) {
                            ...
                            /* VERIYI 32-BIT PARCALAMA (PARSING) VE EKRANA BASMA ISLEMI */
