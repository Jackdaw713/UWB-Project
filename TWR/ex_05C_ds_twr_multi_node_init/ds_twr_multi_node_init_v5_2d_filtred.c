...
#define ANCHOR_2_X 2.0  /* Node 2 (Sag Alt) - Artik 2.0 metre */
#define ANCHOR_2_Y 0.0

#define ANCHOR_3_X 1.0  /* Node 3 (Karsi Duvarin Ortasi) - Artik X'te 1.0 metrede */
#define ANCHOR_3_Y 1.6  /* Y ekseni ayni (1.6 metre) */
...
/* ========================================================= */
#define EMA_ALPHA_XY 0.55      /* %40 Yeni Konum, %60 Eski Konum (Deadband Iptal) */
...
void calculate_2d_position(void) {
    ...
    /* 1. ASAMA: HAM KOORDINAT HESAPLAMA (Artik ucgen yerlesimle cok kararli) */
